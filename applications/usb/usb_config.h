...
#define CONFIG_USB_PRINTF(...) usb_logger(__VA_ARGS__)
...
/* needed to serve the sdcard over usb */
#define CONFIG_USBDEV_MSC_MANUFACTURER_STRING "noname"
#define CONFIG_USBDEV_MSC_PRODUCT_STRING "arm can tool"
#define CONFIG_USBDEV_MSC_VERSION_STRING "1.00"
#define CONFIG_USBDEV_MSC_THREAD 1
#define CONFIG_USBDEV_MSC_STACKSIZE 4096
//#define CONFIG_USBDEV_MSC_MAX_BUFSIZE 2048 // set in rtconfig.h
...
#define CONFIG_USBDEV_MSC_PRIO 20
#endif
...
/* usb-acm character device receive buffer */
#define CONFIG_USBDEV_SERIAL_RX_BUFSIZE 1024
...
#define CONFIG_USB_DWC2_TX1_FIFO_SIZE (512 / 4)  /* GSUSB IN, MSC IN */
#define CONFIG_USB_DWC2_TX2_FIFO_SIZE (1024 / 4) /* CDC0 console IN */
#define CONFIG_USB_DWC2_TX3_FIFO_SIZE (512 / 4)  /* CDC1 gdb server IN, CMSIS-DAP IN */
