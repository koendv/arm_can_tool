...
// force compilation of at32_msp_usb_init()
#define BSP_USING_USBOTG
#define BSP_USING_DEVICE_USBOTG2
...
void at32_msp_spi_init(void *instance)
{
    ...
    if(SPI2 == spi_x)
    {
        ...
        gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
        gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
        gpio_init_struct.gpio_pins = GPIO_PINS_9 | GPIO_PINS_10 | GPIO_PINS_12;
        gpio_init(GPIOA, &gpio_init_struct);
...
void at32_msp_i2c_init(void *instance)
{
    ...
    if(I2C3 == i2c_x)
    {
        ...
        gpio_pin_mux_config(GPIOC, GPIO_PINS_SOURCE8, GPIO_MUX_4);
